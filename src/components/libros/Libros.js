                    ...
                    <tbody>
                         {libros.map(libro => (
                              <tr key={libro.id}>
                                   ...
                                   <td className="font-weight-bold text-success">{libro.existencia}</td>
                                   <td className="text-danger">{libro.existencia - libro.prestados.length }</td>
                                   <td>
                                        <Link to={`/libros/mostrar/${libro.id}`}  className="btn btn-success btn-block"> <i className="fa fa-angle-double-right" aria-hidden="true"></i> {''} Más Información
                                        </Link>
