...
import PropTypes from 'prop-types';
 ...
 class NuevoSuscriptor extends Component {
     ...
     agregarSuscriptor = e => {
          ...
          //  firestore extrayendo de los props
     ...
     // extrae los valores del input y los pasa al state
     leerDato = e => {
          this.setState({
                             ...
                             <div className="col-md-8 mt-5">
                                  <form onSubmit={this.agregarSuscriptor} >
                                      <div className="form-group">
                                        ...
                                        <input type="submit" value=" Agregar Usuario" className="btn btn-success btn-block" />
                                  </form>
                          </div>
                     </div>   
                   </div>
